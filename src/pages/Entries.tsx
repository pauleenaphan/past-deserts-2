    ...
    <div className="flex flex-col w-4/5 md:w-3/4 mx-auto pb-8 gap-4">
      ...
      <div className="flex flex-wrap gap-4">
        {entries.map((entry, index) => (
          <div key={index} className="border border-[#D4C4A8] rounded-br-md rounded-bl-md bg-white w-full md:w-1/4 shadow-md hover:shadow-lg transition-shadow duration-200">
            ...
            <div className="p-6 flex flex-col gap-4 justify-between">
              ...
              <div className="flex justify-end">
                <div className="flex items-center gap-2 text-sm text-gray-500 hover:text-black transition-colors cursor-pointer">
                  <span>Read More</span>
