...
import { addEntry } from '@/lib/entry'
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-bgcolor rounded-lg p-12 w-full max-w-3xl z-50 shadow-xl max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="label block mb-1">Recipe Name</label>
              <input 
                type="text" 
                name="name"
                value={formData.name}
            ...
            <div>
              <label className="label block mb-1">Date Made</label>
              <input 
                type="date" 
                name="date"
                value={formData.date}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="label block mb-1">Rating (1-5 Cactus)</label>
                <CustomSelect
              ...
              <div>
                <label className="label block mb-1">Difficulty</label>
                <CustomSelect
            ...
            <div>
              <label className="label block mb-1">Recipe Link</label>
              <input 
                type="url" 
                name="link"
                value={formData.link}
            ...
            <div>
              <label className="label block mb-1">Summary & Thoughts</label>
              <textarea 
                name="summary"
            ...
            <div>
              <label className="label block mb-1">Labels/Tags</label>
            ...
            <div>
              <label className="label block mb-1">Images</label>
            ...
            <div className="flex justify-end space-x-3 pt-4">
              ...
              >
                {isLoading ? 'Adding...' : isUploading ? 'Uploading...' : 'Add Entry'}
              </button>
            </div>
          </form>
