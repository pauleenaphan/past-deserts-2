...
import { getEntries, Entry, deleteEntry, editEntry } from '@/lib/entry'
...
export default function Admin() {
  ...
  return (
    <div className="flex flex-col w-full md:w-1/2 mx-auto gap-4 p-8">
      ...
      <div className="flex flex-col gap-4">
        {entries.map((entry, index) => (
          <div key={entry.id || index} className="flex justify-between items-center gap-4">
            <div>
